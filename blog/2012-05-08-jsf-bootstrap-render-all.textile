...
The true solution would be to call the Bootstrap Javascript function after each <code>render="@all"</code> in order to attach all Javascript events again. But since I have no idea to do that right now, I have choosen to use a easier workaround.
